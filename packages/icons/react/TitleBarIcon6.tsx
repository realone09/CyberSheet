...
export interface TitleBarIcon6Props extends SVGProps<SVGSVGElement> {
  size?: number | string;
}

const TitleBarIcon6 = React.forwardRef<SVGSVGElement, TitleBarIcon6Props>(
...
TitleBarIcon6.displayName = "TitleBarIcon6";

export default TitleBarIcon6;
