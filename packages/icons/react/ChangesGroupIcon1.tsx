...
export interface ChangesGroupIcon1Props extends SVGProps<SVGSVGElement> {
  size?: number | string;
}

const ChangesGroupIcon1 = React.forwardRef<SVGSVGElement, ChangesGroupIcon1Props>(
...
ChangesGroupIcon1.displayName = "ChangesGroupIcon1";

export default ChangesGroupIcon1;
